...
import com.jl.opengallery.NativeImageLoader.NativeImageCallBack;
import com.jl.opengallery.ShowImage.OnMeasureListener;
...
public class PicAdapter extends BaseAdapter {
    ...
    public PicAdapter(Context context, List<ImageBean> list, GridView mGridView) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.row_pic_item, null);
