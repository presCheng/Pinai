...
public class PicItemAdpter extends BaseAdapter {
    ...
    public PicItemAdpter(Context context, List<String> list, GridView mGridView) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_pic_item_item, null);
