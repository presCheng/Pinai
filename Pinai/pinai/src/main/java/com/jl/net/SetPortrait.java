...
public class SetPortrait {
    ...
    public SetPortrait(String id, String portrait,
        ...
        }, Config.KEY_ACTION, Config.ACTION_SETPORTRAIT, Config.KEY_TOKEN,
                Config.TOKEN, Config.KEY_ID, id, Config.KEY_PORTRAIT, portrait);
    }
