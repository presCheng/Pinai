 ...
 * 转发消息
 */
public class AtyForwardMessage extends AtyPickContactNoCheckbox {
    ...
    protected void onListItemClick(int position) {
        if (position != 0) {
            ...
            Intent intent = new Intent(AtyForwardMessage.this, ChatAlertDialog.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            Intent intent = new Intent(this, AtyChat.class);
            if (selectUser == null)
                return;
            // it is single chat
