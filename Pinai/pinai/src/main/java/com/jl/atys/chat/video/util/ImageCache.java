 ...
 * {@link com.jl.atys.chat.video.util.ImageCache#getInstance(android.support.v4.app.FragmentManager, com.jl.atys.chat.video.util.ImageCache.ImageCacheParams)}
 * to get an instance of this class, although usually a cache should be added
 * directly to an {@link ImageWorker} by calling
 * {@link ImageWorker#addImageCache(android.support.v4.app.FragmentManager, com.jl.atys.chat.video.util.ImageCache.ImageCacheParams)}
 * .
 */
public class ImageCache {
    ...
    /**
     * Return an {@link com.jl.atys.chat.video.util.ImageCache} instance. A {@link com.jl.atys.chat.video.util.ImageCache.RetainFragment} is used
