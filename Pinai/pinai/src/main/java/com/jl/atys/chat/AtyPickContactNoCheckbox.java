 ...
 * 转发消息
 */
public class AtyPickContactNoCheckbox extends AtySupport {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_pick_contact_no_checkbox);
    ...
    private void getContactList() {
        ...
        for (Entry<String, User> entry : users.entrySet()) {
            if (!entry.getKey().equals(Constant.NEW_FRIEND_USERNAME) && !entry.getKey().equals(Constant.GROUP_USERNAME))
