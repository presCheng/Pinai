...
import com.jl.atys.chat.task.LoadLocalBigImgTask;
import com.jl.atys.chat.utils.ImageCache;
import com.jl.atys.chat.widget.photoview.PhotoView;
 ...
 * 下载显示大图
 */
public class ShowBigImage extends AtySupport {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.aty_show_big_image);
