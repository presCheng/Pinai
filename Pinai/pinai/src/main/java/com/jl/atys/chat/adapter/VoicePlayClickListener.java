...
public class VoicePlayClickListener implements View.OnClickListener {
    ...
    public void stopPlayVoice() {
        ...
        isPlaying = false;
        ((AtyChat) activity).playMsgId = null;
    ...
    public void playVoice(String filePath) {
        ...
        ((AtyChat) activity).playMsgId = message.getMsgId();
    ...
    public void onClick(View v) {
        if (isPlaying) {
            if (((AtyChat) activity).playMsgId != null && ((AtyChat) activity).playMsgId.equals(message.getMsgId())) {
