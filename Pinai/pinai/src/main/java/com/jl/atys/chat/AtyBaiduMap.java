...
public class AtyBaiduMap extends AtySupport {
    ...
    public static AtyBaiduMap instance = null;
    ...
    class MyGeneralListener implements MKGeneralListener {
        ...
        public void onGetNetworkState(int iError) {
            if (iError == MKEvent.ERROR_NETWORK_CONNECT) {
                Toast.makeText(AtyBaiduMap.this, "您的网络出错啦！", Toast.LENGTH_LONG).show();
            } else if (iError == MKEvent.ERROR_NETWORK_DATA) {
                Toast.makeText(AtyBaiduMap.this, "输入正确的检索条件！", Toast.LENGTH_LONG).show();
            }
            // ...
        }
