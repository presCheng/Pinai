...
import com.jl.atys.chat.domain.VideoEntity;
import com.jl.atys.chat.video.util.ImageCache;
import com.jl.atys.chat.video.util.ImageResizer;
import com.jl.atys.chat.video.util.Utils;
import com.jl.atys.chat.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
        ...
        if (position == 0) {
            ...
            intent.setClass(getActivity(), AtyRecorderVideo.class);
