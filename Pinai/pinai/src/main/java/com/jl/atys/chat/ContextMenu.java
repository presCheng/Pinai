 ...
 * 点击聊天信息的弹出菜单
 */
public class ContextMenu extends AtySupport {
    ...
    public void copy(View view) {
        setResult(AtyChat.RESULT_CODE_COPY, new Intent().putExtra("position", position));
        finish();
    }

    public void delete(View view) {
        setResult(AtyChat.RESULT_CODE_DELETE, new Intent().putExtra("position", position));
        finish();
    }

    public void forward(View view) {
        setResult(AtyChat.RESULT_CODE_FORWARD, new Intent().putExtra("position", position));
        finish();
    }

    public void open(View v) {
        setResult(AtyChat.RESULT_CODE_OPEN, new Intent().putExtra("position", position));
        finish();
    }

    public void download(View v) {
        setResult(AtyChat.RESULT_CODE_DWONLOAD, new Intent().putExtra("position", position));
        finish();
    }

    public void toCloud(View v) {
        setResult(AtyChat.RESULT_CODE_TO_CLOUD, new Intent().putExtra("position", position));
        finish();
    }
