...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     *                               {@link com.jl.atys.chat.video.util.AsyncTask.Status#RUNNING} or
     *                               {@link com.jl.atys.chat.video.util.AsyncTask.Status#FINISHED}.
     * @see #executeOnExecutor(Executor, Object[])
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.jl.atys.chat.video.util.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
