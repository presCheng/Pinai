...
import com.jl.customs.timer.OnWheelChangedListener;
import com.jl.customs.timer.OnWheelScrollListener;
 ...
 */
public class WheelViewG extends View {
    /**
     * Scrolling duration
     */
     ...
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0x7f060000;
    /**
    ...
    // Listeners
    private List<OnWheelChangedGListener> changingListeners = new LinkedList<OnWheelChangedGListener>();
    private List<OnWheelScrollGListener> scrollingListeners = new LinkedList<OnWheelScrollGListener>();

    /**
     * Constructor
     */
    public WheelViewG(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public WheelViewG(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }
     ...
     * Constructor
     */
    public WheelViewG(Context context) {
        super(context);
        initData(context);
    }
    ...
    private void initData(Context context) {
        VALUE_TEXT_COLOR = getResources().getColor(R.color.background_pink);
     ...
     */
    public void addChangingListener(OnWheelChangedGListener listener) {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (OnWheelChangedGListener listener : changingListeners) {
     ...
     * @param listener the listener
     */
    public void addScrollingListener(OnWheelScrollGListener listener) {
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (OnWheelScrollGListener listener : scrollingListeners) {
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
            float textWidth = FloatMath.ceil(Layout.getDesiredWidth("0",
                    itemsPaint));
            if (getTextItem(0).equals("白羊")||getTextItem(0).equals("*北京")){
