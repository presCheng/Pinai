...
public class ReportDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public ReportDialog create() {
            ...
            // 实例化自定义主题的对话框
            final ReportDialog dialog = new ReportDialog(context,
                    R.style.Dialog);
            final View layout = inflater.inflate(R.layout.report_dialog, null);
                    ...
                    layout.findViewById(R.id.dialog_submit)
                            .setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    EditText et = (EditText) layout.findViewById(R.id.dialog_content);
